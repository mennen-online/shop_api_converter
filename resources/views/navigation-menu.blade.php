        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Endpoint::class)
                        <x-dropdown-link href="{{ route('endpoints.index') }}">
                        Endpoints
                        </x-dropdown-link>
                        @endcan
                </x-nav-dropdown>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @can('view-any', App\Models\Shop::class)
                <x-jet-responsive-nav-link href="{{ route('shops.index') }}">
                Shops
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Endpoint::class)
                <x-jet-responsive-nav-link href="{{ route('endpoints.index') }}">
                Endpoints
                </x-jet-responsive-nav-link>
                @endcan
